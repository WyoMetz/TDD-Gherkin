...
namespace GherkinTests.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("StatusSearch")]
    public partial class StatusSearchFeature
    {
...
#line hidden
        ...
        public virtual void ActiveOrNotActiveStatus(string tA, string bLDG_NUM, string rOOM, string sTATUS, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("TA", tA);
            argumentsOfScenario.Add("BLDG_NUM", bLDG_NUM);
